...
df_asa <- csv_airfoil_data_to_dataframe(aircraft_dataframe$airfoil_wing, "Asa")
df_eh  <- csv_airfoil_data_to_dataframe(aircraft_dataframe$airfoil_horizontal_stabilizer, "Emp. Horizontal")
df_ev  <- csv_airfoil_data_to_dataframe(aircraft_dataframe$airfoil_vertical_stabilizer, "Emp. Vertical")
df_aviao <- csv_airfoil_data_to_dataframe(aircraft_dataframe$aircraft, "Aeronave")
