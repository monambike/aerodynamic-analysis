...
subtitle: "Entendendo o comportamento <em>aerodinâmico</em> com a <br> <b>visualização de dados</b>"
format:
  revealjs:
    theme:
      - default
      - ../scss/main.scss
      - ../scss/modules/slideshow.scss
    transition: slide
    title-slide-attributes:
      class: first-slide
      data-background-video: ../resources/videos/background-sky.mp4
    ...
    footer: |
      <img src='../resources/images/logo-ufv.png' class='footer-logo-ufv' height='50px'>
editor: visual
---
...
:::notes
E um ramo da física (dentro da mecânica dos fluidos, sim, o ar é um fluido) que estuda o movmento do ar e as forças que ele exerce sobre corpos sólidos em movimento ou imersos nele. Ou seja no avião, na pá do ventilador.

Agora os coeficientes aerodinâmicos são grandezas qe quantificam o comportamento desses objetos em um fluido. Tipo a força de resistência, sustentação, instabilidade, etc.
:::
...
![(KPMG) Comparação da aerodinâmica de um caça militar com um avião comercial.](../resources/images/aircraft-comparison.png)
...
::: notes
\[(Exemplo de Narrativa, Remover Depois) Aqui temos o comparativo do modelo x com o modelo y. Perceba que modelos de aviões militares são diferentes dos aviões comerciais que são diferentes de modelos menores como aviões táxi. Percebam que esse modelo requer que você mantenha esse tipo de curva "a" esse outro que você mantenha um tipo de curva "b"\]
:::
